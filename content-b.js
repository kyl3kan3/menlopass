...
/* ---------------- Red flags ---------------- */
const REDFLAGS = [
  {n:'Any vaginal bleeding 12+ months after your last period', why:'Postmenopausal bleeding needs <b>prompt medical assessment</b>, even if it happens only once or is just spotting. More than 90% of people diagnosed with endometrial cancer have postmenopausal bleeding, although most bleeding has a non-cancer cause. ACOG updated its guidance in April 2026: for most patients, the initial evaluation should include both transvaginal ultrasound and endometrial tissue sampling because ultrasound alone can miss some cancers. <a href="https://www.acog.org/news/news-releases/2026/04/acog-publishes-updated-guidance-evaluation-postmenopausal-bleeding" target="_blank" rel="noopener noreferrer">Read ACOG’s 2026 update</a>.'},
  {n:'Unscheduled bleeding while on hormone therapy', why:'Bleeding is common in the first few months of systemic hormone therapy and is often benign, but it still needs safety-netting. Tell the clinician who prescribes your therapy. Seek prompt assessment if bleeding is heavy, persists, starts after a period without bleeding, or continues beyond the interval your clinician told you to expect. NICE amended its guidance in April 2026 to address unscheduled bleeding while taking systemic HRT. <a href="https://www.nice.org.uk/guidance/ng23" target="_blank" rel="noopener noreferrer">Check current NICE NG23 guidance</a>.'},
  ...
  {n:'Emergency now — chest pain or pressure; sudden or severe breathlessness; coughing blood; or fainting', why:'These can be signs of a heart attack or a blood clot in the lungs. <b>Call emergency services now</b>: 911 in the US or Canada, 999 in the UK, 112 in the EU and many other countries, or your local emergency number. Do not drive yourself. If you cannot make the call, ask someone nearby to call and stay with you.'},
  {n:'New swelling, warmth, redness, or pain in one leg', why:'This can be a deep-vein blood clot and needs <b>urgent, same-day medical assessment</b>. If it occurs with chest pain, sudden breathlessness, coughing blood, severe light-headedness or fainting, call emergency services now (911 US/Canada, 999 UK, 112 EU and many countries, or your local emergency number).'},
  {n:'Emergency now — a sudden “worst-ever” headache, or headache with weakness, facial droop, confusion, trouble speaking, loss of vision or collapse', why:'These can be signs of stroke or bleeding in the brain. <b>Call emergency services now</b> and do not drive yourself. A new or clearly changed headache without those emergency signs still deserves timely medical assessment rather than being assumed to be hormonal.'},
  {n:'Thoughts of harming yourself or of not wanting to be alive', why:'If you may act on these thoughts, have made a plan, or cannot keep yourself safe, <b>call emergency services now</b> (911 US/Canada, 999 UK, 112 EU and many countries, or your local number) or go to the nearest emergency department/A&amp;E. Do not stay alone: tell someone you trust and ask them to remain with you; move away from anything you might use to hurt yourself if you can do so safely. For urgent crisis support when you are not in immediate danger, call or text <a href="tel:988">988</a> in the US or Canada, call Samaritans on <a href="tel:116123">116 123</a> in the UK or Republic of Ireland, or use <a href="https://findahelpline.com/" target="_blank" rel="noopener noreferrer">Find A Helpline</a> to locate a verified service elsewhere. A directory is not a substitute for emergency services when danger is immediate.'},
  {n:'Low mood, anxiety, hopelessness, or loss of interest that is not lifting', why:'These symptoms deserve proper assessment and treatment; do not assume they are “just menopause.” Contact a clinician or mental-health professional soon. If thoughts of self-harm or suicide appear, use the emergency and crisis guidance above.'},
  ...
  {n:'If you take fezolinetant: jaundice, dark urine, pale stools, itching, right-upper abdominal pain, unusual tiredness, reduced appetite, nausea or vomiting', why:'The FDA boxed warning covers rare but serious liver injury. <b>Stop taking fezolinetant immediately and seek medical attention, including liver blood tests.</b> Do not wait for a routine appointment. US prescribing information requires liver tests before treatment, monthly for the first 3 months, and at months 6 and 9. <a href="https://www.fda.gov/drugs/drug-safety-communications/fda-adds-warning-about-rare-occurrence-serious-liver-injury-use-veozah-fezolinetant-hot-flashes-due" target="_blank" rel="noopener noreferrer">Read the FDA safety communication</a>.'}
];
...
/* ---------------- Sources ---------------- */
const SOURCES_HTML = `
<p class="tiny">Reference links checked <b>3 August 2026</b>. Guidelines, medicine labels and emergency resources can change; use the linked current version and confirm decisions with a qualified clinician or pharmacist.</p>
<div class="callout warn"><span class="ctitle">Educational tracker — not a medical device</span>
Meno Compass is intended for education, self-reflection and preparing for a clinical conversation. It has not been independently validated to diagnose or stage menopause, detect disease, predict risk, monitor treatment, or recommend personalised care, and it has not been reviewed, cleared, approved or certified as a medical device by the FDA, MHRA or another regulator. It cannot monitor you or contact emergency services. Do not use it to delay professional or emergency care.</div>
<p class="xtiny">Source links open third-party websites and require internet access. Meno Compass does not add your journal or profile data to those links.</p>
<h4>Primary clinical guidance and regulator documents</h4>
<ul class="plain srcs">
<li><a href="https://menopause.org/professional-resources/position-statements" target="_blank" rel="noopener noreferrer">The Menopause Society — Position Statements</a>: <i>2023 Nonhormone Therapy</i>; <i>2022 Hormone Therapy</i>; <i>2021 Management of Osteoporosis in Postmenopausal Women</i>; and <i>2020 Genitourinary Syndrome of Menopause</i>. The 2022 hormone-therapy statement is published in <i>Menopause</i> 2022;29(7):767–794, <a href="https://doi.org/10.1097/GME.0000000000002028" target="_blank" rel="noopener noreferrer">doi:10.1097/GME.0000000000002028</a>.</li>
<li>National Institute for Health and Care Excellence (NICE), <a href="https://www.nice.org.uk/guidance/ng23" target="_blank" rel="noopener noreferrer"><i>Menopause: identification and management</i>, NG23</a> (updated 2024; amended April 2026), and <a href="https://www.nice.org.uk/guidance/ta1143" target="_blank" rel="noopener noreferrer"><i>Fezolinetant for treating moderate to severe vasomotor symptoms associated with menopause</i>, TA1143</a> (31 March 2026).</li>
<li>American Urological Association, SUFU and AUGS, <a href="https://www.auanet.org/guidelines-and-quality/guidelines/genitourinary-syndrome-of-menopause" target="_blank" rel="noopener noreferrer"><i>Genitourinary Syndrome of Menopause Guideline</i></a> (2025).</li>
<li>US Preventive Services Task Force: <a href="https://www.uspreventiveservicestaskforce.org/uspstf/recommendation/osteoporosis-screening" target="_blank" rel="noopener noreferrer">osteoporosis screening</a> (2025), <a href="https://www.uspreventiveservicestaskforce.org/uspstf/recommendation/breast-cancer-screening" target="_blank" rel="noopener noreferrer">breast-cancer screening</a> (2024), <a href="https://www.uspreventiveservicestaskforce.org/uspstf/document/ClinicalSummaryFinal/colorectal-cancer-screening" target="_blank" rel="noopener noreferrer">colorectal-cancer screening</a> (2021), and <a href="https://www.uspreventiveservicestaskforce.org/uspstf/document/RecommendationStatementFinal/menopausal-hormone-therapy-preventive-medication" target="_blank" rel="noopener noreferrer">menopausal hormone therapy for primary prevention</a> (2022). The primary-prevention recommendation does not address treatment of menopausal symptoms.</li>
<li>British Menopause Society, <a href="https://thebms.org.uk/publications/tools-for-clinicians/" target="_blank" rel="noopener noreferrer">Tools for Clinicians</a>, including the HRT Guide and migraine guidance; Medicines and Healthcare products Regulatory Agency, <a href="https://www.gov.uk/drug-safety-update/hormone-replacement-therapy-hrt-further-information-on-the-known-increased-risk-of-breast-cancer-with-hrt-and-its-persistence-after-stopping" target="_blank" rel="noopener noreferrer">HRT breast-cancer risk update and absolute-risk tables</a> (2019).</li>
<li>American College of Obstetricians and Gynecologists (ACOG), <a href="https://www.acog.org/news/news-releases/2026/04/acog-publishes-updated-guidance-evaluation-postmenopausal-bleeding" target="_blank" rel="noopener noreferrer"><i>Updated Guidance on Evaluation of Postmenopausal Bleeding</i></a> (16 April 2026), and <a href="https://www.acog.org/clinical/clinical-guidance/clinical-consensus/articles/2023/11/compounded-bioidentical-menopausal-hormone-therapy" target="_blank" rel="noopener noreferrer"><i>Compounded Bioidentical Menopausal Hormone Therapy</i>, Clinical Consensus No. 6</a> (2023; reaffirmed 2026).</li>
<li>US Food and Drug Administration: <a href="https://www.fda.gov/drugs/drug-alerts-and-statements/fda-requests-labeling-changes-related-safety-information-clarify-benefitrisk-considerations" target="_blank" rel="noopener noreferrer">requested menopausal hormone-therapy label changes</a> (10 November 2025), <a href="https://www.fda.gov/news-events/press-announcements/fda-approves-labeling-changes-menopausal-hormone-therapy-products" target="_blank" rel="noopener noreferrer">approved label changes for six products</a> (12 February 2026), and <a href="https://www.fda.gov/drugs/drug-safety-communications/fda-adds-warning-about-rare-occurrence-serious-liver-injury-use-veozah-fezolinetant-hot-flashes-due" target="_blank" rel="noopener noreferrer">fezolinetant liver-injury safety communication</a> (updated 16 December 2024). Product-specific prescribing information remains controlling.</li>
<li>Harlow SD et al., <a href="https://www.asrm.org/practice-guidance/practice-committee-documents/executive-summary-of-the-stages-of-reproductive-aging-workshopd10-addressing-the-unfinished-agenda-of-staging-reproductive-aging-2012/" target="_blank" rel="noopener noreferrer"><i>Executive summary of the Stages of Reproductive Aging Workshop +10</i></a>. <i>Fertil Steril.</i> 2012;97(4):843–851; European Society of Human Reproduction and Embryology, <a href="https://www.eshre.eu/Guidelines-and-Legal/Guidelines/Premature-ovarian-insufficiency" target="_blank" rel="noopener noreferrer"><i>International Guideline on Premature Ovarian Insufficiency</i></a> (2024).</li>
<li>Davis SR et al., <a href="https://academic.oup.com/jcem/article/104/10/4660/5556103" target="_blank" rel="noopener noreferrer"><i>Global Consensus Position Statement on the Use of Testosterone Therapy for Women</i></a>. <i>J Clin Endocrinol Metab.</i> 2019;104(10):4660–4666. doi:10.1210/jc.2019-01603.</li>
<li>El Khoudary SR et al., <a href="https://professional.heart.org/en/science-news/menopause-transition-and-cardiovascular-disease-risk-implications-for-timing-of-early-prevention" target="_blank" rel="noopener noreferrer"><i>Menopause Transition and Cardiovascular Disease Risk: Implications for Timing of Early Prevention</i></a>. American Heart Association Scientific Statement. <i>Circulation.</i> 2020;142:e506–e532. doi:10.1161/CIR.0000000000000912.</li>
<li>Maki PM et al., <a href="https://pubmed.ncbi.nlm.nih.gov/30179986/" target="_blank" rel="noopener noreferrer"><i>Guidelines for the evaluation and treatment of perimenopausal depression</i></a>. <i>Menopause.</i> 2018;25(10):1069–1085. doi:10.1097/GME.0000000000001174.</li>
<li>Sateia MJ et al., <a href="https://aasm.org/wp-content/uploads/2017/07/PharmacologicTreatmentofInsomnia.pdf" target="_blank" rel="noopener noreferrer"><i>Clinical Practice Guideline for the Pharmacologic Treatment of Chronic Insomnia in Adults</i></a>. <i>J Clin Sleep Med.</i> 2017;13(2):307–349. doi:10.5664/jcsm.6470.</li>
<li>US National Institutes of Health Office of Dietary Supplements: evidence summaries for <a href="https://ods.od.nih.gov/factsheets/calcium-HealthProfessional/" target="_blank" rel="noopener noreferrer">calcium</a> and <a href="https://ods.od.nih.gov/factsheets/VitaminD-HealthProfessional/" target="_blank" rel="noopener noreferrer">vitamin D</a>. These are reference-intake and evidence summaries, not personalised supplement prescriptions.</li>
</ul>
<h4>Selected cohorts and trials used in the modules</h4>
<ul class="plain srcs">
<li><a href="https://www.swanstudy.org/" target="_blank" rel="noopener noreferrer">Study of Women’s Health Across the Nation (SWAN)</a> and <a href="https://www.whi.org/" target="_blank" rel="noopener noreferrer">Women’s Health Initiative (WHI)</a> cohort and trial programmes.</li>
<li>Johnson KA et al., <a href="https://academic.oup.com/jcem/article/108/8/1981/7025342" target="_blank" rel="noopener noreferrer"><i>Efficacy and Safety of Fezolinetant in Moderate to Severe Vasomotor Symptoms Associated With Menopause</i></a> (SKYLIGHT 2). <i>J Clin Endocrinol Metab.</i> 2023;108(8):1981–1997. doi:10.1210/clinem/dgad058.</li>
<li>Pinkerton JV et al., <a href="https://jamanetwork.com/journals/jama/fullarticle/2822766" target="_blank" rel="noopener noreferrer"><i>Elinzanetant for the Treatment of Vasomotor Symptoms Associated With Menopause</i></a> (OASIS 1 and 2). <i>JAMA.</i> 2024;332(16):1343–1354. doi:10.1001/jama.2024.14618.</li>
<li>Watson SL et al., <a href="https://doi.org/10.1002/jbmr.3284" target="_blank" rel="noopener noreferrer"><i>High-Intensity Resistance and Impact Training Improves Bone Mineral Density and Physical Function</i></a> (LIFTMOR). <i>J Bone Miner Res.</i> 2018;33(2):211–220. doi:10.1002/jbmr.3284.</li>
<li>Santer M et al., <a href="https://www.bmj.com/content/381/bmj-2022-074349" target="_blank" rel="noopener noreferrer"><i>Effectiveness of spironolactone for women with acne vulgaris</i></a> (SAFA). <i>BMJ.</i> 2023;381:e074349. doi:10.1136/bmj-2022-074349.</li>
</ul>
