...
peri is intended for education, self-reflection and preparing for a clinical conversation. It has not been independently validated to diagnose or stage menopause, detect disease, predict risk, monitor treatment, or recommend personalised care, and it has not been reviewed, cleared, approved or certified as a medical device by the FDA, MHRA or another regulator. It cannot monitor you or contact emergency services. Do not use it to delay professional or emergency care.</div>
<p class="xtiny">Source links open third-party websites and require internet access. peri does not add your journal or profile data to those links.</p>
